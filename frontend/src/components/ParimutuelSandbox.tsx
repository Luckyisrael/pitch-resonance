      ...
      <div className="p-5 space-y-5">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[9px] font-mono tracking-[0.2em] font-black text-amber-400 uppercase">Time-Decay Engine</span>
          </div>
          <span className="text-[9px] font-mono text-zinc-500 uppercase font-bold">anti-exploit</span>
        </div>

        <p className="text-[10px] font-mono text-zinc-500 leading-relaxed">
          Test how the Solana smart contract implements a time-decayed weight on late stakes to reward early risk-takers and prevent late-game hedging.
        </p>

        {/* Control sliders */}
        <div className="space-y-3.5 bg-[#0C0C0D] p-4 border border-zinc-900 font-mono text-xs">
          {/* Toggle Team */}
        ...
        <div className="grid grid-cols-2 gap-px bg-zinc-800">
          ...
          <div className="bg-[#0C0C0D] p-4 text-center">
            <span className="text-[8px] font-mono text-zinc-500 font-bold block uppercase leading-none">EFFECTIVE STAKE</span>
        ...
        {/* Comparison results */}
        <div className="p-3.5 bg-[#0C0C0D] border border-zinc-900 font-mono text-[10px] space-y-2 text-zinc-400">
          <div className="flex justify-between items-center">
            <span className="font-bold flex items-center gap-1"><TrendingUp className="w-3 h-3 text-zinc-500" /> Standard Payout:</span>
